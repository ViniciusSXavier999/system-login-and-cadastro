package com.vxgm.loginregistration.service;
...
public class UserService {
	...
	public Optional<User> atualizarUsuario(User user) {
		...
		if (repository.findById(user.getId()).isPresent()) {
			 ...
			 */
			Optional<User> buscaUsuario = repository.findByUser(user.getUser());
	...
	*/
	...
	public Optional<UserLogin> autenticaUsuario(Optional<UserLogin> usuarioLogin) {
		 ...
		 * 
		 */
		Optional<User> usuario = repository.findByUser(usuarioLogin.get().getUser());
